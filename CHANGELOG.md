...
- Add support for Wagtail 7.0 LTS and 7.3
- Add support for Django 6.0
- Drop support for Wagtail 5.2, 6.0, 6.1, 6.2 and 6.3
- Fix ad-hoc filter support in Django 5+ (see [#55](https://github.com/wagtail-nest/wagtail-modeladmin/pull/55))
