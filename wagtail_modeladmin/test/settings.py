...
ALLOWED_HOSTS = ["localhost", "testserver", "127.0.0.1", "0.0.0.0"]
...
ROOT_URLCONF = "wagtail_modeladmin.test.urls"
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_wagtail_modeladmin.db"),
}
